 ...
 * @create date 2020-06-12 17:22:05
 * @desc
...
main (int argc, char *argv[])
{
    ...
    // Set nCsma to 1 if user set it to 0
    ...
    pointToPoint.EnablePcap ("trace/bus_topo/bus_topo", p2pNodes.Get (0)->GetId (), 0);
    csma.EnablePcap ("trace/bus_topo/bus_topo", csmaNodes.Get (nCsma)->GetId (), 0, false);
    csma.EnablePcap ("trace/bus_topo/bus_topo", csmaNodes.Get (nCsma-1)->GetId (), 0, false);
